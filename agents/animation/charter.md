...
- [2026-04-04] **Pixel art quality standards — mandatory gate.** For all game-development work that produces, reviews, or specifies production sprites and sprite sheets (hand-made or AI-assisted), **read and apply** [`docs/pixel-art-quality-standards.md`](../../docs/pixel-art-quality-standards.md) before signing off. Use its §5 checklist as the rubric for `spritesheet-audit` and for handoffs to Engineering or Creative; cite the doc in animation specs and pipeline recommendations. Do not treat art-bible compliance alone as sufficient without this execution-layer gate. Trigger: any sprite production, review, export approval, or AI animation workflow for in-game art. Context: Founder directive — enforce consistent agentic use of published pixel standards during game development.
