...
- None / [issue description — severity: low/medium/high]
...
*Decisions that require founder input before work can proceed. Include context and recommended option.*

- None / [Decision: [question]. Context: [why it matters]. Recommendation: [preferred option].]
