...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | 2026-03-29: full CI Node suite + email theme Python test passed; agent charter Standing Directives only (plain-language reporting)—no gameplay change. |
