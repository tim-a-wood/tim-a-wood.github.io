...
|---|---|---|---|---|
| AT-01 | Fresh Load And Startup | Verify the prototype loads into the playable zone without crashes or blank screens. | Not Run | Documentation-only change (wizard plan — product vision + five-phase brainstorm); gameplay not re-tested. |
