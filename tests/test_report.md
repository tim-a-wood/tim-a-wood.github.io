...
| UT-02 | Sprite Workbench Suite | Verifies the automated sprite workbench regression suite in `tests/test_sprite_workbench.py` passes. | Not Run | Fixed wizard back-navigation; suite not re-run. |
