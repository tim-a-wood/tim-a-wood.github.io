...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | 2026-03-29: Analytics dashboard no longer duplicates Home chart grid; KPI cards + priorities + Home link in signpost. No new unit tests. Game ATs not run. |
