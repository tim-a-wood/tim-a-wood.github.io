...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | `python3 tests/room_environment_system.test.py` — 20 OK (2026-03-31). Includes biome Gemini step (`generate_biome_pack_visuals`, refresh skip for `biome_visual_generated_at`). |
