...
|---|---|---|---|---|
| AT-01 | Fresh Load And Startup | Verify the prototype loads into the playable zone without crashes or blank screens. | Not Run | Browser not exercised; latest change was OS dashboard (Issues view, issue chat UI, supervisor `/api/issue-chat`) — not `index.html`. |
