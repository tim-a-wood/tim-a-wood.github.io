...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | `python3 -m pytest tests/ -q` — 148 passed, 14 skipped (2026-03-31). `node tests/room-wizard-environment.test.js` — passed. Contrast QA: `?contrast-qa=1` forces black void + masonry styling; themeId `contrast-qa` same (see decision log §13). |
