...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | 2026-03-30: `node tests/game-logic.test.js` OK. Documentation-only add: `docs/brand-charter.html` + `docs/MV-Brand-Charter-v1.pdf` (brand charter); no gameplay impact. Browser ATs not run. |
