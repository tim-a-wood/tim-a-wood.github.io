...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | 2026-03-30: `node tests/game-logic.test.js` OK after removing duplicate underfloor band/cap seam fix + wall mass to floor plane in `index.html`. Browser ATs not run. |
