...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | Ran `game-logic`, `room-editor-export`, `room-wizard-footprint`, `room-wizard-neighbor-align`, `room-wizard-terrain`, `room-wizard-environment` (2026-03-27); all exited 0. Env hooks: distinct BG + starfield tints; samples + R1–R3 use cave / void / sewer + varied tags. |
