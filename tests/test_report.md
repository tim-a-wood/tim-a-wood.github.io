...
|---|---|---|---|---|
| AT-01 | Fresh Load And Startup | Verify the prototype loads into the playable zone without crashes or blank screens. | Not Run | Documentation-only change (`docs/room-wizard-implementation-sprints.md` + wizard plan §7); gameplay not re-tested. |
