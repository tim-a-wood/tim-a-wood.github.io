...
| UT-01 | Unit Test Suite | Verifies the full automated unit test suite in `tests/game-logic.test.js` passes. | Not Run | World height 1200px (viewport unchanged 800x400); camera pans vertically with player; `node` was not available in the current execution environment. |
