...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | 2026-03-29: full CI Node suite + email theme Python test (also in `.github/workflows/test.yml`) passed after light-theme update to `scripts/send_weekly_digest.py`. |
