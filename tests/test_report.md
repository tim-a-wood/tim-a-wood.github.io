...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Not Run | Issue chat can use Cursor Cloud Agents API (`CURSOR_API_KEY`) or OpenAI fallback; no automated API test run. |
