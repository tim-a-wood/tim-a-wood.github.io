...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | `python3 -m pytest tests/ -q` — 148 passed, 14 skipped (2026-03-31). Issue chat: `ISSUE_CHAT_PREFER_OPENAI=1` forces OpenAI over Cursor; UI hint updated. |
