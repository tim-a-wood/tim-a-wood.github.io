...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | `python3 -m pytest tests/ -q` — 148 passed, 14 skipped (2026-03-31). OS dashboard: status JSON `actions` appear as extra workflow mode pills per agent; no new automated tests for dashboard JS. |
