...
| Unit Test Suite | Overall Unit Tests | General unit test suite status. | Pass | Ran `game-logic`, `room-editor-export`, `room-wizard-footprint`, `room-wizard-neighbor-align` (2026-03-27); all exited 0. Reverted prior Workbench nested-band CSS commit; room layout editor top rail replaced with World/Room view toggle (world: 4-step workflow incl. placeholders; room: unchanged wizard rail). |
