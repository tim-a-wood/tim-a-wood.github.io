...
| UT-01 | Unit Test Suite | Verifies the full automated unit test suite in `tests/game-logic.test.js` passes. | Not Run | Added roomType (internal/outdoor) and outdoor no-walls test; `node` was not available in the current execution environment. |
